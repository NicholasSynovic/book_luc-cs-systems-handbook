...
## title: "Innsiden av Java: De grunnleggende konseptene" linkTitle: "Innsiden av Java" date: 2017-01-06 description: > En kort oppsummering av denne siden. Tekst kan **utheves** sller skrives i _kursiv_ og kan ha flere avsnitt.
